...
#from AR.models import ARmodel
import sys
import os
# Add parent directory to path to allow importing AR package
...
parser.add_argument('--model', type=str, default='GARmodel',help='model to select')
# --- CNNRNN option
...
# Handle model name mapping (e.g., 'GAR' -> 'GARmodel')
